...
export function Hero() {
  ...
  const contentY = useTransform(heroProgress, [0, 1], [0, -72]);
  const contentOpacity = useTransform(heroProgress, [0, 1], [1, 0.72]);
  const ambientScale = useTransform(heroProgress, [0, 1], [1, 1.12]);

  return (
    <section
      ref={sectionRef}
      id="hero"
      className="site-container relative pt-6 sm:pt-8"
    >
      <div
        className={cn(
      ...
      >
        ...
        >
          <div className="grid w-full items-center gap-16 lg:grid-cols-[1fr_1fr] lg:gap-20 xl:gap-24">
